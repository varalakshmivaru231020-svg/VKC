...
export default async function BlogDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      {/* Hero: image left, title/meta right on desktop — stacked on mobile */}
      <div className={`grid grid-cols-1 ${blog.imageUrl ? "lg:grid-cols-2" : ""} gap-8 lg:gap-12 items-center mb-12`}>
        {blog.imageUrl && (
      ...
      {/* Body — narrower column for comfortable line length, left-aligned */}
      <div className="max-w-3xl mx-auto pt-8 border-t" style={{ borderColor: "var(--color-parchment)" }}>
        <div
          className="prose prose-sm max-w-none font-body text-left"
