...
export default function LeadershipExperience() {
  return (
    <div className="vkc-about" style={{ background: C.ivory }}>
      ...
      {/* Header band */}
      <section className="relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${C.bark} 0%, #5A3210 100%)` }}>
        <div className="max-w-[1240px] mx-auto px-5 sm:px-8 pt-16 pb-16 sm:pt-20 sm:pb-20">
          <Reveal>
            <Eyebrow color={C.jaggeryLite}>Our Core Team</Eyebrow>
            ...
            <p className="font-body mt-5" style={{ fontSize: 17, lineHeight: 1.7, color: "rgba(255,251,244,0.78)", maxWidth: 620 }}>
