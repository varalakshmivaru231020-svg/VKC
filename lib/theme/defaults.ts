...
export const DEFAULT_THEME: ThemeSettings = {
  // ── Colors ────────────────────────────────────────────
  "color.primary":        "#D9731A",
  "color.primary.dark":   "#A8520A",
  "color.primary.light":  "#EE8B2F",
  "color.primary.50":     "#FDF1E4",
  "color.gold":           "#F5B301",
  "color.gold.light":     "#FFD65C",
  "color.gold.dark":      "#A66A00",
  "color.ivory":          "#FFFBF4",
  "color.cream":          "#FBF1DE",
  "color.parchment":      "#F0DCB6",
  "color.sand":           "#D9B27A",
  "color.text.primary":   "#2B1708",
  "color.text.secondary": "#5C3A1E",
  "color.text.muted":     "#8A6A4E",
  "color.text.disabled":  "#C9B399",
  "color.text.inverse":   "#FFFBF4",
