...
export const DEFAULT_THEME: ThemeSettings = {
  // ── Colors ────────────────────────────────────────────
  "color.primary":        "#C99118",
  "color.primary.dark":   "#9C700F",
  "color.primary.light":  "#DDA83B",
  "color.primary.50":     "#FBF1DC",
  "color.gold":           "#C99118",
  "color.gold.light":     "#E4B958",
  "color.gold.dark":      "#8F6A10",
  "color.royal":          "#063B70",
  "color.royal.dark":     "#042A50",
  "color.royal.light":    "#E8EFF6",
  "color.ivory":          "#FCFAF5",
  "color.cream":          "#F7F0E3",
  "color.parchment":      "#E9DCC3",
  "color.sand":           "#D3BD98",
  "color.text.primary":   "#241A12",
  "color.text.secondary": "#6F6255",
  "color.text.muted":     "#8F8171",
  "color.text.disabled":  "#C7BBAA",
...
export const SETTING_METAS: SettingMeta[] = [
  ...
  { key: "color.royal",          label: "Royal Blue Accent",     group: "colors", type: "color", description: "Restrained secondary accent — badges, footer, one heritage section" },
  { key: "color.royal.dark",     label: "Royal Blue Dark",       group: "colors", type: "color", description: "Hover/pressed state of the royal blue accent" },
  { key: "color.royal.light",    label: "Royal Blue Tint (bg)",  group: "colors", type: "color", description: "Very light blue tint for badge backgrounds" },
