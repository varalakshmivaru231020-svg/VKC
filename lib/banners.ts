export const BANNER_POSITIONS: Record<string, string> = {
  ...
  category_top: "Category — Promo strip (below the page banner)",
  category_banner: "Category — Page banner",
  new_arrivals_banner: "New Arrivals — Page banner",
  shop_top: "Shop — Promo strip (below the page banner)",
  shop_banner: "Shop — Page banner",
  inner_banner_default: "All inner pages — default page banner (used where a page has none of its own)",
  ...
  leadership_banner: "Leadership — Page banner",
  leadership_heritage: "Leadership — Heritage image (where we began)",
  leadership_future: "Leadership — Future image (where we are going)",
  credentials_banner: "Credentials — Page banner",
  blog_banner: "Blogs — Page banner",
  gallery_banner: "Gallery — Page banner",
